...
Original file is located at
    https://colab.research.google.com/drive/18wAcrRwaihh2B452Hjg0WHMSgzyQJIe_
...
sum = "your name is " + name + ", surname is "+surname+", and your age is "+age
print(sum)
...
if number1 % number2 == 0:
    result = "can be devided"
else:
    result = "can not be devided"
